      ...
      <div className="mx-auto max-w-6xl space-y-16">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="overflow-hidden">
            <div className="p-8 border rounded-xl border-border  transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-background/80 hover:bg-background backdrop-blur-sm">
            ...
            <div className="p-8 border rounded-xl border-border transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-background/80 hover:bg-background backdrop-blur-sm">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold">Guilmor</h3>
                    <div className="text-muted-foreground mt-1 text-sm">
                      Tempo integral · 2020 - Presente
                    </div>
                  </div>
